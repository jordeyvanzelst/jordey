# Installation sript for Node configurations and installation

this is a collection of utilities to manage, setup and update masternode instances.
...
| command                               | description                                  |
| :------------------------------------ | -------------------------------------------- |
|  start pivx (all\|number)   | start all or a specific pivx masternode(s)   |
|  restart pivx (all\|number) | stop all or a specific pivx masternode(s)    |
|  stop pivx (all\|number)    | restart all or a specific pivx masternode(s) |
|  cleanup pivx (all\|number) | delete chain data for all pivx masternodes   |
|  status pivx (all\|number)  | systemd process status for a pivx masternode |
|  tail pivx (all\|number)    | tail debug logs for a pivx masternode        |
